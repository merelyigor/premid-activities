...
Ці приклади показують, до якого охайного вигляду Discord Rich Presence прагне цей проєкт.

| Стиль Disney+ | Стиль YouTube Music | Стиль YouTube |
| --- | --- | --- |
| ![Референс Discord Rich Presence Disney+](docs/images/discord-example-disney.png) | ![Референс Discord Rich Presence YouTube Music](docs/images/discord-example-youtube-music.png) | ![Референс Discord Rich Presence YouTube](docs/images/discord-example-youtube.png) |
